...
public class PessoaRepository {
	...
	/**
	 * RETORNA TODAS AS PESSOAS DE UMA DETERMINADA TURMA 
	 * */
	@SuppressWarnings("unchecked")
	public List<PessoaEntity> ConsultaPessoasTurma(String codTurma){
 
		return this.entityManager.createQuery("SELECT nome, turma FROM PessoaEntity p, WHERE turma = '"+codTurma+"' ORDER BY p.nome").getResultList();
	}
